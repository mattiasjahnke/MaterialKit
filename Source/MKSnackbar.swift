...
open class MKSnackbar: UIControl {
            ...
            UIView.animate(
                ...
                animations: {() -> Void in
                    ...
                    if finished {
                        ...
                        self.performDelegateAction(#selector(MKSnackbarDelegate.snackbarDismissed(_:)))
    ...
    fileprivate func arrangeContent() {
        if let textLabel = textLabel, let actionButton = actionButton {
            ...
            let views: Dictionary<String, Any> = [
                "label": textLabel,
                "button": actionButton
            ]
...
private class MKSnackbarManager: NSObject, MKSnackbarDelegate {
    ...
    @objc fileprivate func snackbarDismissed(_ snackbar: MKSnackbar) {
        if var snackbarQueue = snackbarQueue {
